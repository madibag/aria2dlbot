...
from tobrot.plugins.new_join_fn import new_join_f, help_message_f, rename_message_f, start_message_f
from tobrot.plugins.incoming_message_fn import incoming_message_f, incoming_youtube_dl_f, incoming_purge_message_f
from tobrot.plugins.magnet import magnet_link_s
...
if __name__ == "__main__" :
    ...
    #
    MagnetLinkFetcher = MessageHandler(
        magnet_link_s,
        filters=Filters.command(["Magnet"])
    )
    app.add_handler(MagnetLinkFetcher)
    #
